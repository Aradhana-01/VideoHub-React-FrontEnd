import { Box, Container, Heading, Image, VStack, Text } from '@chakra-ui/react';
     ...
     <MyCarousel  />
      ...
      <Container maxW={'container.xl'} minH={'100vh'} p="16">
        ...
        marginBottom={'20'}
          ...
          p={'4'}
          alignItems={'center'}
          direction={['column', 'row']} //(for responsive purpose both col and row)
        >
         <Image src={img5} h={['40', '400']} filter={'hue-rotate(-130deg)'} />    {/* // for responsiveness pass array..it chnges value depending on the screen size */}
...
const MyCarousel = () => (
  ...
  >
    <Box w="full" h={'70vh'}>
      ...
      <Heading bgColor={'blackAlpha.600'} color={'white'} {...headingOptions}>  {/* //above object is created and  spread */}
        Watch The Future
      </Heading>
    </Box>
    <Box w="full" h={'70vh'}>
